...
'******************************************************
Function InitCategoryFeedConnection( mycatagoryID As String ) As Object 

    conn = CreateObject("roAssociativeArray")
    conn.UrlPrefix   = "http://uploadtv.blob.core.windows.net/rokuxml" 
 
      mytest = loadRegistrationToken()
      mytest = tostr ( mytest )
      mytest = strTrim (mytest)      
      myLink =   "/categoriesMadMen" + mytest  + ".xml"

    conn.UrlCategoryFeed = conn.UrlPrefix +   myLink            
